...
Подробная инструкция по тестированию всего flow опросника находится в файле `TESTING_FLOW.md`.

Основные этапы тестирования:
1. Проверка приветствия и согласия на ПД
2. Прохождение 5 базовых вопросов
3. Проверка генерации и ответов на 5 развернутых вопросов
4. Выбор ролевой модели
5. Ввод цели и проверка генерации роадмапа
6. Проверка генерации первого ДЗ
7. Тестирование отправки отчета и оценки ДЗ (хорошо/плохо)
8. Проверка цикла правок ДЗ
